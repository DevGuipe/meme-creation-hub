...
const buildTemplateLayers = (templateKey: string): Layer[] => {
  ...
  switch (templateKey) {
    case 'pop_vs_closed':
      return [
        { id: 'bg', type: 'background', content: 'room', x: 50, y: 50, scale: 1.0, rotation: 0, zIndex: 0 },
    ...
    case 'yes_pop':
      return [
        { id: 'bg', type: 'background', content: 'beach', x: 50, y: 50, scale: 1.0, rotation: 0, zIndex: 0 },
    ...
    case 'click_wars':
      return [
        { id: 'bg', type: 'background', content: 'fire', x: 50, y: 50, scale: 1.0, rotation: 0, zIndex: 0 },
    ...
    case 'karaoke':
      return [
        { id: 'bg', type: 'background', content: 'neon', x: 50, y: 50, scale: 1.0, rotation: 0, zIndex: 0 },
