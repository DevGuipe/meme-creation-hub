...
DROP POLICY IF EXISTS "users_can_soft_delete_memes" ON public.memes;
...
-- ===== MEMES TABLE =====
-- Allow public users to soft-delete memes (UPDATE only when setting deleted_at)
CREATE POLICY "users_can_soft_delete_memes"
ON public.memes
FOR UPDATE
TO public
USING (true)
