-- Corrigir dados de teste usando APENAS valores válidos do enum

-- 1. Adicionar dados de teste com valores corretos
...
('870314eb-2cf6-4a55-a53b-fd9483120ef4', 'reaction_popcat', 10, NOW() - INTERVAL '1 day'),
('870314eb-2cf6-4a55-a53b-fd9483120ef4', 'reaction_flex', 5, NOW() - INTERVAL '2 days'),
-- Eventos da semana passada  
('870314eb-2cf6-4a55-a53b-fd9483120ef4', 'publish', 30, NOW() - INTERVAL '8 days'),
('870314eb-2cf6-4a55-a53b-fd9483120ef4', 'reaction', 15, NOW() - INTERVAL '10 days');
